...
def tp_conf():
    ...
    if not Auto_check:
        ...
        print(
            " [Instruction] --> UnPlug and plug in your WiFi USB adapter, WAIT FOR FEW SECONDS then run the tool again and XEye-tp will do the rest :)   \n")
        print(
            " [Assistance] --> If you need any further assistance, please contact us on our Facebook page: https://fb.com/xEyecs")
        exit()
...
def interct():
    ipp = subprocess.getoutput("ip r |grep " + str(interfaceon))
    ipr = subprocess.getoutput(ipp + " | grep proto | cut -d\" \" -f1")
    ip = re.search(r"(?:\d{1,3}\.){3}\d{1,3}(?:/\d\d?)?", str(ipr))
    time.sleep(2)
    print(
        "[Important] --> ❤️❤️❤️ Harden Your Skills [Coupon Code]: \"FEBXEYE23\" --> \"https://www.udemy.com/user/mostafa-ahmad-abdelmobdy/\" ❤️❤️❤️ ")
    time.sleep(2)
    if ip is not None:
...
def arpspoof():
    ...
    time.sleep(1)
    print(
        "[Instruction] --> To stop the attack and restore all the targets ARP tables, press on the left \"ctrl+c\" once or more if needed")
    try:
        while True:
...
def TheEnd():
    ...
    print("[Important] --> ❤️ If you want to advance in your Cybersecurity and Information Security career, Contact XEye Academy through \"https://XEyecs.com/academy\" ❤️ ")
    print("[XEye Academy] --> Pass any exam certificate, advance in your career with XEye Academy trainers ")
    print("[XEye Academy] --> XEye Academy trainers are certified, highly experienced and skilled")
    print("[XEye Academy] --> XEye Academy onsite, live and recorded trainings are highly practical with special dedicated and sophisticated labs ")
    print("\t\t\t\t❤️ ❤️ ❤️ ❤️ ❤️ ❤️ ❤️ ❤️ ❤️ ❤️ ❤️ ❤️ ❤️ ❤️ ❤️ ❤️ ❤️ ❤️ ❤️ ❤️ ❤️ ❤️ ❤️ ❤️ ❤️ ")
    print("[XEye] --> Want to learn more about XEye? Visit our website through\"https://XEyecs.com\" ")
    print("\n [Author] Eng.Mostafa Ahmad - Cybersecurity Expert and \"XEye\" founder.")
    exit()
Checkroot()
interfaceon = getinterf()
Start()
