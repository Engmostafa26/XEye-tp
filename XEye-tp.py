...
def udte():
    ...
    chkeds = re.search(r"Ya está actualizado", str(chupd))
...
def Start():
    ...
    time.sleep(1)
    print("\n [Website] --> You can visit our website through https://www.xeyecs.com")
    time.sleep(1)
    ...
    time.sleep(1)
    print("\t\t [*] --> Our Facebook Page: https://www.facebook.com/XEyecs")
    time.sleep(1)
